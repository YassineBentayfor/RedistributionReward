...
async function main() {
  ...
  try {
    // Step 1: Account 1 sends 2000 MPT and 2000 MST to both Account 2 and Account 3, and 2000 MPT and 4000 MST to Account 3
    ...
    try {
      ...
      console.error(
        "Error during transfer of 2000 MPT to Account 2 using transferMptTokens function:",
        error
      );
    }
    ...
    // Step 2: Account 1 stakes 2000 MST and then sends 2000 MPT to Account 2
    console.log("Account 1 staking 2000 MST...");
    try {
      const stakeTx1 = await new ContractExecuteTransaction()
        ...
        .setFunction(
          "stakeTokens",
          new ContractFunctionParameters().addUint64(2000)
        )
        .setMaxTransactionFee(new Hbar(20));
      const stakeTxSubmit1 = await stakeTx1.execute(client);
      const stakeTxReceipt1 = await stakeTxSubmit1.getReceipt(client);
      console.log(
        `- Tokens staked by Account 1 using stakeTokens function: ${stakeTxReceipt1.status.toString()}`
      );
    } catch (error) {
      console.error(
        "Error during staking of 2000 MST by Account 1 using stakeTokens function:",
        error
      );
    }

    console.log("Account 1 transferring 2000 MPT to Account 2...");
    try {
      const transferMptTx1 = await new ContractExecuteTransaction()
        ...
        .setMaxTransactionFee(new Hbar(20));
      const transferMptTxSubmit1 = await transferMptTx1.execute(client);
      ...
      console.error(
        "Error during transfer of 2000 MPT by Account 1 to Account 2 using transferMptTokens function:",
        error
      );
    }
    ...
    // Step 3: Account 2 stakes 2000 MST and then sends 4000 MPT to Account 3
    console.log("Account 2 staking 2000 MST...");
    try {
      ...
      console.error(
        "Error during staking of 2000 MST by Account 2 using stakeTokens function:",
        error
      );
    }
    ...
    // Step 4: Account 3 stakes 4000 MST and then sends 200 MPT to Account 1 and 2000 MPT to Account 2
    ...
    console.log("Account 3 transferring 200 MPT to Account 1...");
    try {
      ...
      console.error(
        "Error during transfer of 200 MPT by Account 3 to Account 1 using transferMptTokens function:",
        error
      );
    }
    ...
    console.log("Account 1 unstaking 2000 MST...");
    try {
      const unstakeTx1 = await new ContractExecuteTransaction()
        ...
        .setMaxTransactionFee(new Hbar(20));
      const unstakeTxSubmit1 = await unstakeTx1.execute(client);
      const unstakeTxReceipt1 = await unstakeTxSubmit1.getReceipt(client);
      console.log(
        `- Tokens unstaked by Account 1 using unstakeTokens function: ${unstakeTxReceipt1.status.toString()}`
      );
    } catch (error) {
      console.error(
        "Error during unstaking of 2000 MST by Account 1 using unstakeTokens function:",
        error
      );
    }

    console.log("Account 2 unstaking 2000 MST...");
    try {
      ...
      console.error(
        "Error during unstaking of 2000 MST by Account 2 using unstakeTokens function:",
        error
      );
    }
